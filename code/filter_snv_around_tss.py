...
cosmic_file = 'raw_data/Cosmic_GenomeScreensMutant_v100_GRCh38.tsv'
output_file = cosmic_file[:-4] + '_filtered_snv_tss.tsv'


# Prepare transcriptional start site (TSS) gene coordinate ranges as dictionary
...
# Helper function for filtering for single nucleotide variants (SNVs) within the TSS range
